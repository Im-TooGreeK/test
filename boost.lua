...
-- Hashing
local hasher = not isStudio and loadstring(game:HttpGet("https://raw.githubusercontent.com/Im-TooGreeK/test/refs/heads/main/FHASHER.lua"))()["hasher"] --or require(script.Parent.ModuleScript)['hasher']
